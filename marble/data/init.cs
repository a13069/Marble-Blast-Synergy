...
addMaterialMapping( "custom_sand" ,    SandFrictionMaterial);
addMaterialMapping( "custom_water" ,    WaterFrictionMaterial);
addMaterialMapping( "custom_ice" ,    IceMaterial);
addMaterialMapping( "bounce" ,    BumperMaterial);
