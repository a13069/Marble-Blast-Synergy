...
function initClient()
{
   ...
   if (!$pref::QualifiedLevel["Beginner"])
      $pref::QualifiedLevel["Beginner"] = 1000;
   if (!$pref::QualifiedLevel["Intermediate"])
      $pref::QualifiedLevel["Intermediate"] = 1000;
   if (!$pref::QualifiedLevel["Advanced"])
      $pref::QualifiedLevel["Advanced"] = 1000;
   if (!$pref::QualifiedLevel["Tutorial"])
      $pref::QualifiedLevel["Tutorial"] = 1000;
   if (!$pref::QualifiedLevel["Expert"])
      $pref::QualifiedLevel["Expert"] = 1000;
...
function loadMainMenu()
{
   ...
   $HomeBackground = "marble/client/ui/bk_1.png";
   runPresentation();
   buildMissionList();
