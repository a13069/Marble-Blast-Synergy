...
datablock ItemData(OldSuperJumpItem)
{
...
datablock ItemData(OldSuperBounceItem)
{
   // Mission editor category
   category = "Powerups";
   className = "PowerUp";
...
datablock ItemData(OldShockAbsorberItem)
{
   // Mission editor category
   category = "Powerups";
   className = "PowerUp";
...
datablock AudioProfile(doWaterSfx)
{
...
datablock AudioProfile(PuWaterVoiceSfx)
{
   filename    = "~/data/sound/puWaterVoice.wav";
   description = AudioDefault3d;
   preload = true;
};

datablock AudioProfile(WaterLoopSfx)
{
   filename    = "~/data/sound/Use_Helicopter.wav";
   description = AudioClosestLooping3d;
   preload = true;
};

datablock ShapeBaseImageData(WaterImage)
{
   // Basic Item properties
   shapeFile = "~/data/shapes/images/glow_bounce.dts";
   emap = true;
...
datablock ItemData(WaterItem)
{
   ...
   activeAudio = DoWaterSfx;
   pickupAudio = PuWaterVoiceSfx;

   // Basic Item properties
   shapeFile = "~/data/shapes/items/water.dts";
   mass = 1;
   friction = 1;
   elasticity = 0.3;

   // Dynamic properties defined by the scripts
   pickupName = "a Water PowerUp!";
   useName = "Water PowerUp";
   maxInventory = 1;
};
...
datablock ItemData(OldHelicopterItem)
{
   // Mission editor category
   category = "Powerups";
   className = "PowerUp";
