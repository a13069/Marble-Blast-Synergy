...
datablock StaticShapeData(SignCautionWelcome: SignCaution)
{
   skin = "welcome";
};


datablock StaticShapeData(SignArrow)
{
   // Mission editor category
   category = "Signs";
   className = "Sign";
   ...
   // Basic Item properties
   shapeFile = "~/data/shapes/signs/arrow.dts";
   mass = 1;
   friction = 1;
   elasticity = 0.3;
};

datablock StaticShapeData(SignArrowYellow: SignArrow)
{
   skin = "yellow";
};

datablock StaticShapeData(SignArrowGreen: SignArrow)
{
   skin = "green";
};
